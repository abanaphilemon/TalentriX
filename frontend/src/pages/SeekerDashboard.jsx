        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2 sm:gap-3 shrink-0">
            ...
            <button
              ...
              className="relative inline-flex items-center justify-center gap-1.5 w-9 h-9 sm:w-auto sm:h-auto sm:px-3 sm:py-2 text-sm font-semibold text-secondary bg-secondary/5 hover:bg-secondary/10 rounded-lg transition-colors"
              title="Secure messages"
              aria-label="Secure messages"
            >
              <MessageSquare className="w-4 h-4" /> <span className="hidden sm:inline">Messages</span>
              {unread > 0 && (
                <span className="absolute -top-1 -right-1 min-w-[18px] h-[18px] px-1 rounded-full bg-primary text-secondary text-[10px] font-bold grid place-items-center sm:static sm:min-w-0 sm:p-0 sm:w-auto sm:h-auto sm:px-1">
                  {unread}
                </span>
              )}
            </button>
